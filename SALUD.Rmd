...
# Cargo los archivos exportados de COLMENA
  asistencia <- read_excel("SALUD/CAPS/AsistPublica.xlsx")
  cic <-  read_excel("SALUD/CAPS/CIC.xlsx")
  concepcion <- read_excel("SALUD/CAPS/LaConcepcion.xlsx")
  villa <- read_excel("SALUD/CAPS/VillaLasLomas.xlsx")
  rocamora <- read_excel("SALUD/CAPS/Rocamora.xlsx")
  minata <- read_excel("SALUD/CAPS/Minatta.xlsx")
